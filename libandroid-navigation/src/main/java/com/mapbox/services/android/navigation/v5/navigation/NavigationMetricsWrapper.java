...
final class NavigationMetricsWrapper {
  ...
  static void cancelEvent(SessionState sessionState, MetricsRouteProgress metricProgress, Location location) {
    ...
    if (arrivalDate != null) {
      String dateAndTimePattern = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
      SimpleDateFormat dateFormat = new SimpleDateFormat(dateAndTimePattern, Locale.US);
      String arrivalTimestamp = dateFormat.format(arrivalDate);
      data.setArrivalTimestamp(arrivalTimestamp);
    }
  ...
  static void rerouteEvent(RerouteEvent rerouteEvent, MetricsRouteProgress metricProgress,
    ...
    String dateAndTimePattern = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
    SimpleDateFormat dateFormat = new SimpleDateFormat(dateAndTimePattern, Locale.US);
    String createdDate = dateFormat.format(location.getTime());
    metadata.setCreated(createdDate);
    NavigationState state = new NavigationState(metadata);
  ...
  static void feedbackEvent(SessionState sessionState, MetricsRouteProgress metricProgress, Location location,
                            String description, String feedbackType, String screenshot, String vendorId,
    ...
    FeedbackEventData feedbackEventData = new FeedbackEventData(userId, feedbackType, feedbackSource);
